...
export class IniApi extends ConveyorApi {
    ...
    writeIniValue = (path: string, section: string, key: string, value: string, createIfMissing?: boolean) => this.invoke('writeIniValue', path, section, key, value, createIfMissing)
