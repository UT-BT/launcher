                    ...
                    {newsFeed.length > 0 && (
                        ...
                        >
                            <NewsCard
                                ...
                                newSince={newsSeen}
                                className="grid grid-cols-1 md:grid-cols-1 gap-3 space-y-0 max-h-[15rem] overflow-y-auto pr-1 [scrollbar-width:thin] [scrollbar-color:rgba(148,163,184,0.25)_transparent] [&::-webkit-scrollbar]:w-1 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-hairline/20"
                            />
                        </SpotlightSection>
                    )}
