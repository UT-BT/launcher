    ...
    return (
        <>
            ...
            <ConfirmModal
                ...
                title="Delete match"
                message={`Delete this match between ${teamNames.a} and ${teamNames.b}?`}
                detail={match.status === 'scheduled'
                    ? 'This cannot be undone. It already has a time agreed with both teams — it will be cancelled and both teams notified in Discord.'
