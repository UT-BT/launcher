...
export function MarketCard({ market, now, canPredict, onPredict }: MarketCardProps) {
    ...
    return (
        <div className="p-3 rounded-lg border border-white/10 bg-card/40 flex flex-col gap-2.5">
            ...
            <div className="flex flex-wrap items-center justify-between gap-2 text-xs">
                <div className="flex flex-wrap items-center gap-x-3 gap-y-1 text-muted-foreground">
                    ...
                    {countdown && <span className="text-amber-300 tabular-nums">Closes in {countdown}</span>}
