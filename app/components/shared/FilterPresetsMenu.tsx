                ...
                <DropdownMenu open={menuOpen} onOpenChange={setMenuOpen} modal={false}>
                    <DropdownMenuTrigger asChild>
                        <button
                            ...
                            className={cn(
                                ...
                                activePreset
                                    ? 'bg-accent-500/15 border-accent-500/40 text-accent-200 hover:bg-accent-500/25 hover:border-accent-500/60'
                        ...
                        >
                            ...
                            {label}
                            {activePreset ? (
                                <span className="text-[11px] font-semibold text-accent-200 max-w-[160px] truncate">
                                    · {activePreset.name}
                                </span>
                            ) : presets.length > 0 && (
                    ...
                    <DropdownMenuContent align="start" className="min-w-56 max-w-80">
                        ...
                        <DropdownMenuItem
                            ...
                            className={cn(
                                'flex items-center gap-2 text-accent-300',
