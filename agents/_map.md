...
| data-sources | `agents/data-sources.md` | client-side API contract + asset URLs + favorites/patreon sync + the event bracket/format contract | `app/utils/api.ts`, `app/utils/chartBuckets.ts`, `app/components/pages/admin/components/controls.tsx`, `app/utils/patreon.ts`, `app/utils/server-utils.ts`, `app/hooks/useServerFavorites.ts`, `app/components/pages/events/manage/formatFields.tsx`, `app/components/pages/events/predictions/predictionsShared.tsx`, `app/components/pages/events/predictions/PredictionsTab.tsx` |
