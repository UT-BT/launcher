...
| shared-components | `agents/shared-components.md` | inventory of reusable components + when to use each + the pick/ban visual core | `app/components/shared/{PlayerInfo,DataTable,CapTimeLink,MapNavLink,MapNameCell,ColumnsMenu,FilterPresetsMenu}.tsx`, `app/components/pages/events/pickban/components/*` |
